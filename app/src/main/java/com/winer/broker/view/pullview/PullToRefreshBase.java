 ...
 *******************************************************************************/
package com.winer.broker.view.pullview;
...
import com.winer.broker.view.pullview.internal.FlipLoadingLayout;
import com.winer.broker.view.pullview.internal.LoadingLayout;
import com.winer.broker.view.pullview.internal.RotateLoadingLayout;
import com.winer.broker.view.pullview.internal.Utils;
import com.winer.broker.view.pullview.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public void onRefreshSuccessComplete(){
		if (isRefreshing()) {
			if(mHeaderLayout instanceof RotateLoadingLayout){
				((RotateLoadingLayout)mHeaderLayout).switchSuccess();
			}
