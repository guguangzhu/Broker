 ...
 *******************************************************************************/
package com.winer.broker.view.pullview.internal;
...
import com.winer.broker.view.pullview.ILoadingLayout;
import com.winer.broker.view.pullview.PullToRefreshBase;
import com.winer.broker.view.pullview.PullToRefreshBase.Mode;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	protected ImageView successImage;
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		refreshImage=(ImageView)findViewById(R.id.pull_to_refreshing_image);
		successImage=(ImageView)findViewById(R.id.pull_success_image);
